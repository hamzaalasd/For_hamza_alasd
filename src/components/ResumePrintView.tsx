      ...
      <div style={{ padding: '11mm 15mm 10mm 15mm' }}>
        ...
        {exps.length > 0 && (
          <>
            ...
            {exps.filter(exp => exp.showInResume !== false).slice(0, 3).map((exp, i) => (
        ...
        {projects.length > 0 && (
          <>
            ...
            {projects.filter(p => p.showInResume !== false).slice(0, 3).map((p, i) => (
        ...
        {certs.length > 0 && (
          <>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '2pt' }}>
              <tbody>
                {certs.filter(c => c.showInResume !== false).slice(0, 3).map(c => (
